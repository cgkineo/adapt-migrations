...
export default class Journal {
  ...
  constructor ({
    ...
    const addEntry = (method, keys, value = null, previous = null) => {
      ...
      if (this.isUndoing || keys[0] !== 'data') return
    ...
    this.data = {
      ...data,
      originalFromPlugins: JSON.parse(JSON.stringify(data.fromPlugins)),
      toPlugins: JSON.parse(JSON.stringify(data.fromPlugins))
    }
    /**
     * Proxied version of data.
     * @type {Proxy<Object|Array>}
     * */
    this.subject = wrap(this.data)
  }
